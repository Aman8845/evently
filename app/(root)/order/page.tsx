  ...
  return (
    <>
      <section className=" bg-gray-50 bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <h3 className="max-w-7xl lg:mx-auto p-5 md:px-10 xl:px-0 w-full h3-bold text-center sm:text-left ">Orders</h3>
      </section>
      ...
      <section className="max-w-7xl lg:mx-auto p-5 md:px-10 xl:px-0 w-full overflow-x-auto">
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="text-[14px] font-medium leading-5 border-b text-gray-500">
              ...
              <>
                {orders &&
                  orders.map((row: IOrderItem) => (
                    <tr
                      key={row._id}
                      className="text-[14px] font-normal leading-5 lg:text-[16px] lg:font-normal lg:leading-6 border-b "
